...
//                mCamera.startPreview();
     ...
     *
     * @param focusRect Rect - new area for auto focus
     * @param cb        the callback to run
     */
    public void doTouchFocus(final Rect focusRect, AutoFocusCallback cb) {
        try {
            // cancle previous auto focus request for new request
            cancelAutoFocus();
            ...
            // request new auto focus and register listener
            autoFocus(cb);
        } catch (Exception e) {
            e.printStackTrace();
...
//                            " is not supported on this device.");
     ...
     */
    @SuppressLint("InlinedApi")
    private Camera createVideoCamera() {
        Camera camera = null;
        ...
        try {
            ...
            Log.d(TAG, "Step camera is created.");
            ...
            Camera.Size optimalSize = getOptimalVideoSize(mSupportedVideoSizes,
                    mSupportedPreviewSizes, mRequestedPreviewWidth, mRequestedPreviewHeight);
            ...
            parameters.setPreviewSize(mCamcorderProfile.videoFrameWidth, mCamcorderProfile.videoFrameHeight);

            Log.d(TAG, "Step setPreviewSize is seted.");
...
//                            " is not supported on this device.");
    ...
    private boolean prepareVideoRecorder() {
        try {
            ...
            Log.e(TAG,"mCamera is unlocked and set to mediarecorder");

            // Step 2: Set sources
            mMediaRecorder.setAudioSource(MediaRecorder.AudioSource.DEFAULT);
            mMediaRecorder.setVideoSource(MediaRecorder.VideoSource.CAMERA);

            Log.e(TAG,"mMediaRecorder set vidio and audio source");


            // Step 3: Set a CamcorderProfile (requires API Level 8 or higher)
            mMediaRecorder.setProfile(mCamcorderProfile);

            Log.e(TAG,"mMediaRecorder set camcoder profile");


            // Step 4: Set output file
            mOutputFile = getOutputMediaFile(CameraHelper.MEDIA_TYPE_VIDEO);
            if (mOutputFile == null) {
                return false;
            }
            mMediaRecorder.setOutputFile(mOutputFile.getPath());
            Log.e(TAG,"mOutputFile path :"+mOutputFile.getPath()+"");
            ...
            Log.e(TAG,"mMediaRecorder is started");
...
//                Environment.DIRECTORY_PICTURES), "CameraSample");
    ...
    private class CameraPreviewCallback implements Camera.PreviewCallback {
        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            Log.d(TAG, "Step onPreviewFrame is seted.");
    ...
    private class FrameProcessingRunnable implements Runnable {
        ...
        FrameProcessingRunnable(Detector<?> detector) {
            ...
            mDetector = detector;
            Log.d(TAG, "Step Detector is seted.");
        }
        ...
        void setActive(boolean active) {
            synchronized (mLock) {
                mActive = active;
                Log.d(TAG, "Step setActive is seted.");
                mLock.notifyAll();
            }
        }
        ...
        void setNextFrame(byte[] data, Camera camera) {
            synchronized (mLock) {
                ...
                Log.d(TAG, "Step NextxFream is seted.");
        ...
        public void run() {
            ...
            while (true) {
                synchronized (mLock) {
                    ...
                    Log.d(TAG, "Step outputFrame is seted.");
